    ...
    <div className='homePageWrapper'>
      <div className='formWrapper'>
        ...
        <div className='inputField'>
            <input type='text' className='input' placeholder='ROOM ID' value={roomId} onChange={(e)=>{setRoomId(e.target.value)}} onKeyUp={handleEnter} ></input>
            <input type='text' className='input' placeholder='USERNAME' value={userName} onChange={(e)=>{setuserName(e.target.value)}} onKeyUp={handleEnter}></input>
